...
export const MAP_ANITA_LAUNCHER: RSMap = {
  ...
  '현상금 임무': [
    ...
    {
      difficulty: 4,
      recommendationLevel: 48,
      boss: {
        title: '자작나무에 사는 생물들이 정말 많아요!',
        name: '해룡자작나무 생물',
      },
      rewards: [
        {
